                    ...
                    <div className={styles.landingContent}>
                        <div className={styles.statement}>
                            ...
                            <p className={styles.description}>
                                Looking to grow your customer base or find ways
                                to keep them coming back? Take control of your
                                business by integrating your Square account with
                                Dingo!
                            </p>
                            {ctaButton}
                        </div>
                        ...
                        <div className={styles.steps}>
                            <div className={styles.step}>
                                ...
                                <p className={styles.stepDescription}>
                                    Start off by connecting Dingo with your
                                    Square account. We&apos;ll analyze your
                                    inventory so customers can make informed
                                    decisions based off recommendations given to
                                    them.
                                </p>
                            </div>
                            <figure className={styles.step}>
                                ...
                                <p className={styles.stepDescription}>
                                    Take control of what gets recommended all
                                    inside the Dingo dashboard. Want to take a
                                    pause? Turn off all recommendations until
                                    you&apos;re ready to get back on again.
                                </p>
                            </figure>
                            <figure className={styles.step}>
                                <img
                                ...
                                />
                                <h3 className={styles.stepLabel}>
                                    Watch customers come back again... and
                                    again!
                                </h3>
                                <p className={styles.stepDescription}>
                                    Gain insight into how Dingo is impacting
                                    your business. Whether it&apos;s visualizing
                                    trends over time or recording your
                                    conversion rates, we have the numbers for
                                    you.
                                </p>
                            </figure>
                        </div>
